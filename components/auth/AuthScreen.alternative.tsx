...
/**
 * VERSÃO ALTERNATIVA - SEM LOGO
 * 
 * Esta versão usa o nome "AutoZen" em texto estilizado
 * ao invés da logo em imagem.
 * 
 * Para usar esta versão:
 * 1. Renomeie AuthScreen.tsx para AuthScreen.backup.tsx
 * 2. Renomeie este arquivo para AuthScreen.tsx
 */
        ...
        <div className="flex flex-col justify-between p-8 lg:p-16 relative">
          ...
          >
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-glow to-blue-primary flex items-center justify-center glow-blue">
                <span className="text-xl font-bold text-white">AZ</span>
              </div>
              <div>
                <h1 className="text-3xl font-bold text-text-primary tracking-tight">
                  AUTO<span className="text-blue-glow">ZEN</span>
                </h1>
